...
class CryptSha512 extends AbstractPassProtection implements GenerationCapableInterface, ValidationCapableInterface, SaltCapableInterface, IterationsCapableInterface
{
    ...
    protected function getSalt()
    {
        $iterations = (new NumbersManipulators($this->getIterations(5000)))
            ->max(1000)
            ->min(999999999);
        return (string) (new StringsManipulators("rounds=%s$%s$"))
